...
CLI: it knows how to turn a :class:`~trading_platform.core.models.BacktestResult`,
a :class:`~trading_platform.metrics.performance.MetricSet` and the opaque
...
class Report:
    ...
    def to_markdown(self) -> str:
        ...
        from trading_platform.reporting.markdown import render_markdown
...
def build_report(
    *,
    ...
    Metrics are computed lazily through :func:`trading_platform.metrics.compute_metrics`
