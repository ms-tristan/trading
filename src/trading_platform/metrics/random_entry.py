...
* no metric maths is duplicated: the ``exposure`` of the real run and the
  ...
  :func:`~trading_platform.metrics.performance.compute_metrics` (each simulated
  leg is wrapped in a synthetic :class:`~trading_platform.core.models.BacktestResult`);
* determinism: a single ``numpy.random.default_rng(random_seed)`` generator drives
  ...
  :mod:`trading_platform.validation.monte_carlo`, determinism is guaranteed for a
  given numpy version;
...
from trading_platform.metrics.benchmark import _benchmark_prices
from trading_platform.metrics.performance import compute_metrics
...
#:
#: Mirrors :data:`trading_platform.validation.monte_carlo.SERIALISED_SIMULATIONS`
...
class RandomEntryResult:
    ...
    :class:`~trading_platform.validation.monte_carlo.MonteCarloResult`, so a
    ...
    * ``percentile / 100 + p_value >= 1`` always holds, with equality as soon as
    ...
    def to_dict(self) -> dict[str, Any]:
        ...
        :class:`~trading_platform.validation.monte_carlo.MonteCarloResult`, which
    ...
    def histogram(self, bins: int = 20) -> dict[str, list[float]]:
        ...
        Mirrors :meth:`~trading_platform.validation.monte_carlo.MonteCarloResult.histogram`
...
def _simulated_balance(
    ...
    :func:`trading_platform.metrics.benchmark.buy_and_hold_equity`.
...
def random_entry_benchmark(
    ...
    * **exposure** -- the realised simulated exposure is
    ...
    :func:`~trading_platform.metrics.performance.compute_metrics` on a synthetic
    :class:`~trading_platform.core.models.BacktestResult` holding
    ...
    :func:`trading_platform.validation.monte_carlo.monte_carlo`.
