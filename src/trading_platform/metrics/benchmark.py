...
* no metric maths is duplicated here: the benchmark equity curve is wrapped in a
  synthetic :class:`~trading_platform.core.models.BacktestResult` and handed over
  to the frozen :func:`trading_platform.metrics.performance.compute_metrics`;
...
* :data:`BENCHMARK_METRIC_NAMES` is the frozen, ordered subset of the 23
  :data:`~trading_platform.metrics.performance.METRIC_NAMES` that is meaningful
...
``random_entry``
    ...
    :mod:`trading_platform.metrics.random_entry` (see
    :func:`~trading_platform.metrics.random_entry.random_entry_benchmark`).  It is
...
def _distribution_variant_error(variant: str) -> MetricsError:
    ...
    return MetricsError(
        ...
        "trading_platform.metrics.random_entry.random_entry_benchmark "
        "(gate: trading_platform.validation.validate_random_entry); "
...
def _normalise_index(index: pd.Index) -> pd.DatetimeIndex:
    ...
    Mirrors :func:`trading_platform.core.models._normalise_equity` so that the
...
class BenchmarkResult:
    ...
    :class:`~trading_platform.metrics.performance.MetricSet`, so downstream
...
def _benchmark_result(
    ...
    *,
    ...
    :class:`~trading_platform.core.models.BacktestResult` and measured with the
    frozen :func:`~trading_platform.metrics.performance.compute_metrics`, so not a
...
def compute_benchmark(
    ...
    *,
    ...
    MetricsError
        ...
        has no curve: use
        :func:`~trading_platform.metrics.random_entry.random_entry_benchmark`), or
