...
comparison produced by :mod:`trading_platform.metrics.benchmark` into a single
...
and it lives in :mod:`trading_platform.validation.random_entry` (gate
...
:func:`trading_platform.validation.walk_forward.walk_forward`.  ``variant ==
...
if TYPE_CHECKING:  # pragma: no cover - types only, keeps this module importable
    from trading_platform.metrics.benchmark import BenchmarkComparison
...
def _resolve_comparison_fn(comparison_fn: ComparisonFn | None, variant: str) -> ComparisonFn:
    ...
    from :mod:`trading_platform.metrics.benchmark` *inside this function*, so the
    ...
    try:  # lazy on purpose: the metrics layer is a downstream package
        from trading_platform.metrics.benchmark import compare_benchmark
...
def validate_benchmark(
    ...
    *,
    ...
    variant:
        ...
        :data:`trading_platform.metrics.benchmark.DEFAULT_BENCHMARK_VARIANT`),
    ...
    comparison_fn:
        ...
        :func:`trading_platform.metrics.benchmark.compare_benchmark`".  It is
