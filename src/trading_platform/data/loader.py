...
from trading_platform.data.cache import CacheFormat, OHLCVCache
from trading_platform.data.validation import ensure_ohlcv, validate_ohlcv
...
class CcxtDataProvider:
    ...
    installed raises :class:`~trading_platform.core.errors.DataDownloadError`
        ...
        *,
        ...
        try:
            ...
            raise DataDownloadError(
                "ccxt is not installed: pip install 'trading-platform[exchange]'"
            ) from exc
...
class OHLCVLoader:
    ...
    raises :class:`~trading_platform.core.errors.InsufficientDataError`.
    """
