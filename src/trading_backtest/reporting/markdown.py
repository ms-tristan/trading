"""Deterministic Markdown rendering of a :class:`~trading_backtest.reporting.builder.Report`.
...
* every :class:`~trading_backtest.reporting.builder.ReportSection` becomes a
...
if TYPE_CHECKING:  # pragma: no cover - typing only, no runtime import
    from trading_backtest.reporting.builder import Report, ReportSection
