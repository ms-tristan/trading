...
from trading_backtest.core.constants import DEFAULT_TIMEFRAME, periods_per_year
from trading_backtest.core.errors import MetricsError
from trading_backtest.core.models import BacktestResult, TradeRecord
from trading_backtest.metrics.drawdown import drawdown_duration, max_drawdown
...
def compute_metrics(
    ...
    *,
    ...
    result:
        ...
        :class:`~trading_backtest.core.models.BacktestResult`).
    timeframe:
