...
:mod:`trading_backtest.realtime.risk`) and the configuration -- never by two
...
``CcxtBroker``
    ...
    method bodies**: ``import trading_backtest.realtime.broker`` must stay valid
...
turns an :class:`~trading_backtest.realtime.models.OrderRequest` into a venue
answer and a stream of :class:`~trading_backtest.realtime.models.BrokerEvent`.
"""
...
from trading_backtest.core.errors import BrokerError, BrokerUnavailableError, RealtimeError
