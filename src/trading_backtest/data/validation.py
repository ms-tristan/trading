...
``ensure_ohlcv``
    ...
    contract, or raises :class:`~trading_backtest.core.errors.DataValidationError`
...
def ensure_ohlcv(data: pd.DataFrame, *, name: str = "data") -> pd.DataFrame:
    ...
    * the five :data:`~trading_backtest.core.constants.REQUIRED_OHLCV_COLUMNS`
...
def validate_ohlcv(
    ...
    *,
    ...
    raise_on_error:
        ...
        :class:`~trading_backtest.core.errors.DataValidationError` carrying the
